...
async def setup_db():
    ...
    await DB.con.execute(sql,123,'student',"user1","name1","surname1",1,"faculty1")
    await DB.con.execute(sql,124,'student',"user2","name2","surname2",1,"faculty2")
    await DB.con.execute(sql,125,'student',"user3","name3","surname3",1,"faculty3")
