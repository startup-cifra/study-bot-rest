...
@groups_router.post('/user/groups', response_model=models.SuccessfulResponse, status_code=status.HTTP_200_OK)
...
@groups_router.post('/group', response_model=models.SuccessfulResponse, status_code=status.HTTP_200_OK)
async def add_group(chat_id: int, name: str) -> models.SuccessfulResponse:
    await create_group(chat_id, name)
    return models.SuccessfulResponse()


@groups_router.put('/user/groups', response_model=models.SuccessfulResponse, status_code=status.HTTP_200_OK)
